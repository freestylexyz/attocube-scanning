...
class Ui_attocube_UI(object):
    ...
    def retranslateUi(self, attocube_UI):
        ...
        self.Y_up_button.setText(QCoreApplication.translate("attocube_UI", u"UP", None))
        ...
        self.X_down_button.setText(QCoreApplication.translate("attocube_UI", u"DOWN", None))
        self.X_up_button.setText(QCoreApplication.translate("attocube_UI", u"UP", None))
        self.X_stp_label.setText(QCoreApplication.translate("attocube_UI", u"X", None))
        self.Y_down_button.setText(QCoreApplication.translate("attocube_UI", u"DOWN", None))
