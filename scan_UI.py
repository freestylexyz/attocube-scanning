...
################################################################################
## Form generated from reading UI file 'scan_UI.ui'
##
...
class Ui_Scan_UI(object):
    def setupUi(self, Scan_UI):
        ...
        self.readdelay_scan_spinbox.setValue(10)
        ...
        self.pixelnum_scan_spinbox.setValue(128)
